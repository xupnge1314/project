...
if ($intId) {
	...
	$arrOtherGoods = db_factory::query("select * from ".TABLEPRE."witkey_service where uid=".$arrOwnerInfo['uid']." and service_id!=".$arrServiceInfo['service_id']." and service_status=2 order by on_time desc limit 3");
