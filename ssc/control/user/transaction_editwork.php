...
if($objId&&!$intTaskId){
	...
	$strCustomSql = 'select a.id,a.extdata,b.f_name,b.f_tips,b.f_fixed_len,b.f_min_len,b.f_max_len,b.f_required,b.f_code from '.TABLEPRE.'witkey_custom_fields_ext a LEFT JOIN '.TABLEPRE.'witkey_custom_fields b ON a.c_id = b.id where a.objid = '.$objId;
