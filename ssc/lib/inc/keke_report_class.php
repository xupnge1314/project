	...
	public static function process_notify($process_type = 'pass', $report_info, $user_info, $to_userinfo, $process_result,$process_reply ='') {
		...
		if ($report_info ['report_type'] != '1') {
			...
			if ($process_type == 'pass') { 
				...
				keke_msg_class::notify_user($to_userinfo ['uid'], $to_userinfo ['username'], 'reported_pass', $trans_name . $_lang ['process_notice'],$result,1);
			}
			if ($process_type == 'nopass') { 
				...
				keke_msg_class::notify_user($to_userinfo ['uid'], $to_userinfo ['username'], 'reported_nopass', $trans_name . $_lang ['process_notice'],$result,1);
			}
		}
	}
