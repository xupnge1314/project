 ...
 *活动公告
 */
$arrEvent = db_factory::query(sprintf("select art_id,art_title,listorder,is_recommend,pub_time from %switkey_article where cat_type='article' and art_cat_id=366 order by is_recommend desc, listorder asc, pub_time desc limit 0,5",TABLEPRE),1,$intIndexCacheTime);
