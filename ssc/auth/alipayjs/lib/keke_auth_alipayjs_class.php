<?php
class keke_auth_alipayjs_class extends keke_auth_base_class {
	public static function get_instance($code = 'alipayjs') {
		static $obj = null;
		if ($obj == null) {
			$obj = new keke_auth_alipayjs_class ( $code );
		}
		return $obj;
	}
	public function __construct($code = 'alipayjs') {
		parent::__construct ( $code );
		$this->_primary_key = 'alipayjs_a_id';
