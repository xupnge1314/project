...
class uc_note {
	...
	function renameuser($get, $post) {
		...
		db_factory::updatetable(TABLEPRE.'witkey_member', array('username'=>$get[newusername]), array('uid'=>intval($get['uid'])));
		db_factory::updatetable(TABLEPRE.'witkey_space', array('username'=>$get[newusername]), array('uid'=>intval($get['uid'])));
		return API_RETURN_SUCCEED;
	}
