...
/**(alipayjs)auth_list.htm**/
	'alipayjs_auth_list'=>'支付宝认证列表',
	'auth_num'=>'认证编号',
	'auth_user'=>'认证用户',
	'auth_status'=>'认证状态',
	'wait_audit'=>'待审核',
	...
	'confirm_nopass'=>'确定要审核不通过？',
/**(bank)auth_list.php**/
	'alipayjs_auth_pass'=>'支付宝认证通过',
	'alipayjs_auth_nopass'=>'支付宝认证不通过',
	'alipayjs_auth_delete'=>'支付宝认证被删除',
	'mulit_delete_alipay_auth'=>'批量删除了支付宝认证',
	'mulit_pass_alipayjs_auth'=>'批量审核通过支付宝认证',
	'mulit_nopass_alipayjs_auth'=>'批量设定未通过支付宝认证',
);