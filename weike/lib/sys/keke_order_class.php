...
class keke_order_class {
	...
	public static function create_order_charge($order_type,$pay_type,$return_order_id,$obj_id,$uid,$username,$pay_money,$order_status,$pay_info,$out_trade_no,$pay_time =NULL){
