...
{
    $lang->my->menu->effort  = array('link' => 'Effort|my|effort|', 'subModule' => 'effort');
...
$lang->project->menu->effort  = 'Effort|project|effort|projectID=%s';

/* Insert effort into $lang->company->menu.*/
$lang->company->menu->effort  = 'Effort|company|effort|';
