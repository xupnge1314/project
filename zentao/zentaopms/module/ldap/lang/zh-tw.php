...
$lang->ldap->noldap->content = '本配置依賴于PHP的LDAP擴展，需要加載LDAP擴展，你可以修改php.ini檔案，或者可以安裝LDAP擴展。具體安裝可以參考該文檔 <a href="http://www.zentao.net/help-read-79704.html" target="_blank">安裝PHP的LDAP擴展</a> 。';
