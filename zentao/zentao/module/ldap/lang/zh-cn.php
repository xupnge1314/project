...
$lang->ldap->noldap->content = '本配置依赖于PHP的LDAP扩展，需要加载LDAP扩展，你可以修改php.ini文件，或者可以安装LDAP扩展。具体安装可以参考该文档 <a href="http://www.zentao.net/help-read-79704.html" target="_blank">安装PHP的LDAP扩展</a> 。';
