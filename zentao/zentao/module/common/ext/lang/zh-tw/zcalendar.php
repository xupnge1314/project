 ...
 */
$lang->my->menu->todo['link'] = "待辦|todo|calendar|";
$lang->my->menu->effort       = array('link' => "日誌|effort|calendar|", 'subModule' => 'effort');

$lang->company->menu->effort       = array('link' => "日誌|company|calendar|", 'alias' => 'effort');
$lang->company->menu->todo['link'] = "待辦|company|todo|";

$lang->project->menu->task['alias'] .= ',calendar';
$lang->project->menu->effort         = array('link' => "日誌|project|effortcalendar|projectID=%s", 'subModule' => 'effort');
