 ...
 */
$lang->my->menu->todo['link'] = 'TODO|todo|calendar|';
$lang->my->menu->effort       = array('link' => "Effort|effort|calendar|", 'subModule' => 'effort');

$lang->company->menu->effort         = array('link' => "Effort|company|calendar|");
$lang->company->menu->todo['link']   = "TODO|company|todo|";

$lang->project->menu->task['alias'] .= ',calendar';
$lang->project->menu->effort         = array('link' => "Effort|project|effortcalendar|projectID=%s", 'subModule' => 'effort');
