function setLeftInput(obj)
{
  ...
  {
      $(obj).parent().prev().find('input').attr('disabled', false);
      $(obj).parent().prev().find('input').removeClass('disabled');
  }
  else
  {
      $(obj).parent().prev().find('input').attr('disabled', true);
      $(obj).parent().prev().find('input').addClass('disabled');
  }
}
