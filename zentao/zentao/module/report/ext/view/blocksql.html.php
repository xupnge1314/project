<div class='panel'>
  <div class='panel-heading'>
    <strong><?php echo $lang->crystal->sql?></strong>
  </div>
  <form method='post' action='<?php echo inlink('custom', "step=1&reportID=$reportID")?>' target='hiddenwin' class='sqlForm'>
    ...
    <div style='padding: 0 10px 10px;'>
      <?php echo html::submitButton($lang->crystal->query, "class='btn'")?>
      <?php echo html::commonButton($lang->crystal->addVar, "class='btn addVar'")?>
  ...
  <div class="modal-dialog w-800px">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method='post' action='<?php echo inlink('ajaxCheckVar', "reportID=$reportID")?>' target='hiddenwin'>
          <div class='panel'>
